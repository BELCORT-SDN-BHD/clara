...
> `docs/plan/active/mohe-grill-rulings-2026-08-30.md:159`; minuted by ADR-0077 (pending signature).

## 14 · The beta-pivot supplement (source ADR-0077, 2026-08-31 — **PENDING THE OWNER'S SIGNATURE**; drafted, not yet law)
84. **The paid-beta gate** — three walls + Stripe checkout success; RM0/"trial" until the pricing sitting; nothing invoices until `amounts_ruled`. *(裁-57 · 58 · 68 · 73)* **85. Honest notes for a paused lane are a lawful permanent state**, swept against the lane's `PROGRESS.md` row. *(the 2026-08-31 direction)* **Law 28 amended:** cross-session review under one model family satisfies the money-touching requirement *(裁-84; dissent on file)*; **law 83's ceremony is post-beta** *(裁-76)*.
