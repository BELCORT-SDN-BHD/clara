...
28. **Cross-model adversarial review before merging money-touching code** *(0026)*, and
    ...
    review laws are NOT awaiting an ADR fold — 裁-140 abolished that instrument; they carry a combined row in §15 — 裁-107(a/b) seam↔door tables · 裁-108 unnumbered-migration arming ·
