...
> **ARCHIVAL NOTE (2026-08-01):** this design record was recovered from the never-merged
> `feat/currency-defect-design` branch during the Wave-D seam housekeeping. Its READER half
> SHIPPED as the v9 currency reader (PR #133, 3-round ladder); the OVERRIDE half stays a named
> deferral. Landed for the record — nothing here re-opens a shipped decision.
...
> Moved to `currency-defect-design-part2.md` at recovery (2026-08-01) — the 500-line ceiling;
> split-never-prune. Nothing edited.
