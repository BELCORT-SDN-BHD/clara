...
### 裁-141 — ⌘K "Do" behind the allowlist (裁-37): the palette pre-filters on DB-computed role rank + transcribed door floors, guarded against drift; the door stays the only authority (owner, 2026-09-03 ~01:20 MYT)
