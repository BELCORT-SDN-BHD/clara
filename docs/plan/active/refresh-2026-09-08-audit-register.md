...
3. The [runtime route is resolved](https://github.com/BELCORT-SDN-BHD/clara/issues/607#issuecomment-5588548302). Production integration, replay/delivery/cutover and hosted tests are named implementation gates. The [direct-debit scope question](https://github.com/BELCORT-SDN-BHD/clara/issues/611) remains the only unanswered product choice identified by the original-prompt coverage pass.
