...
**Also inherited, from 2026-09-02:** the nine LANE LAWS in
[`frontend-sprint-handoff-2026-08-31-orders.md`](frontend-sprint-handoff-2026-08-31-orders.md) §C —
native lanes only (裁-133) · the PROCESS LAW (kill only your own PID, never a name and never a
CommandLine substring) · the fold-round MUTANT PANEL as a deliverable · the panel's buffer-restore
rule on a dirty tree · PRINT-THE-THING · the eight-item MERGE-FORWARD LAW · the MERGED-TREE LAW ·
the GATE-SHAPE LAW · the ARMED-PR LAW. Each one was minted by a defect that reached a PR that day.
