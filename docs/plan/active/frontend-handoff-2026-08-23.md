...
| 17 | **Fixed assets · adjustments · advances · accounts** | **BUILT** | `apps/dashboard/app/assets/`, `apps/dashboard/app/rules/`, `apps/dashboard/app/advances/`, `apps/dashboard/app/accounts/` |
