...
| `wake_propose_identifier_promotion` | `(p_client, p_kind, p_value, p_sightings int, p_citations jsonb, p_rationale, p_model, p_op_key)` | `clara_wake_filing` | the typed proposal card |
