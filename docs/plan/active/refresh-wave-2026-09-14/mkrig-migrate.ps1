param([string]$Name, [int]$Port, [string]$Db)
...
Set-Location C:\Users\zhant\Desktop\clara-rebuild
...
Write-Host ("rig $Name :$Port/$Db ready in {0:N0}s" -f $sw.Elapsed.TotalSeconds)
