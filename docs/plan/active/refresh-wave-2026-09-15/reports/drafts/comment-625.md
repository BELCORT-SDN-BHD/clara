...
| AC2 preview before password | Done | `0224_preview_invite.sql`; `p625.web.preview_called`/`.joined`; round 1 added the real-browser leg (`members-invite-walk.spec.ts:254,310`) proving document order and a single Bearer-scoped POST |
