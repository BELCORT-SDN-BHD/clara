...
| **D21** | Retirement rides this item; the **full-64 backfill is a terminal-check precondition**; the WB-R2 sites are re-pointed, never deleted. | contract-ruled + owner |
