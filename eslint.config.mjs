...
//   - Build output, deps, and generated types are ignored.
//
...
// The ClaraBook brand system bans raw color values in page components. These
// two selectors enforce that rule.
//
...
const NO_RAW_COLOR_VALUES = {
  ...
  message:
    ...
    + " NOTE: this selector cannot tell a real colour from any other short hex-looking token after `#` — a plain ticket reference like `#658` trips it too (#994). If that is your case, the fix is to REWORD the string (e.g. spell it out as \"ticket 658\"), never to weaken this rule.",
};
