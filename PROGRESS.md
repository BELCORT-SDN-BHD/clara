...
the port-wave plan) — **LIVE 135/`0140`** (the 0139+0140 D1 window RAN 2026-08-28, as-run
in docs/plan/completed), F-A7b BUILD-AUTHORIZED, port wave ruled A + T0 in review)*
...
1. **THE FRONTEND 磨合 WINDOW IS OPEN AND RUNNING** (its own session; backend live 131/`0136`).
   **Pre-flight DISCHARGED**: `chatTurn_v14` deployed + bundle-proven serving (2026-08-27); the
   ...
   flight**: T0 in independent review → wave A ‖ P4 build tranches; the `0139`+`0140`
   window RAN 2026-08-28 (live 135); next the live-data e2e walk (Q9 rung 5).
