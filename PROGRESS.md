...
*(as of 2026-08-27 evening — **THE 磨合 WINDOW IS OPEN: THE apps/web FRONTEND CORE P1-P3 IS
MERGED IN FULL (#357-#367) · `0137`+`0138` CEREMONIED (windowless; as-run in
docs/plan/completed) · F-A7b GATE CLOSED**, on the W4 backend base — **LIVE 133/`0138`**,
Wave-F backend fully live end to end, card-1 stage (b) lit; trued at every clock-out)*
...
1. **THE FRONTEND 磨合 WINDOW IS OPEN AND RUNNING** (its own session; backend live 131/`0136`).
   **Pre-flight DISCHARGED**: `chatTurn_v14` deployed + bundle-proven serving (2026-08-27); the
   ...
   RULED IN FULL. **Done so far**: P1 (#357) · F-A7b's gate closed and BUILD-AUTHORIZED
   (#359/#360) · **P2+P3 MERGED IN FULL** (#362 #363 #364 #367; `0137` #365 and `0138` #368
   beside them) · the evening grill R1-R7 ruled and merged (#369). **In flight**: the F-A4
   PR-2a design round · the statutory_deadlines DDL lane · then the live-data e2e walk → P4.
   **Still owed in this window**
