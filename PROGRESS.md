...
T0 seam + Wave A's T3/T6/T5 MERGED (#382 #385 #386 #387), T9 in its merge rung, Wave B
(T4/T7/T8/T10) building; P4's DB tranche-1 (`0141`) in dual review**)*
...
1. **THE FRONTEND 磨合 WINDOW IS OPEN AND RUNNING** — pre-flight discharged, P1-P3 merged,
   ...
   **In flight**: T9's merge rung · Wave B (T4/T7/T8/T10) building · P4's `0141` in dual
   review. **Still owed in this window** (owner rulings,
