...
- ~~F-A5/PR-3 scanner nit~~ — **MOOT**: its named checker script was itself deleted by `0118`
  (verified via git history, no successor); see the AGENTS.md staleness flag in Known issues.
