...
- ~~**OWNER CARD: Annex A.4 row 7 vs invariant (i) — `agent_prepared` label on preparation-less
  ...
  branch f-a4/pr-1b2-a4-truth, migration `packages/db/migrations/UNNUMBERED_f_a4_pr_1b2_a4_truth.sql` (CoRs
