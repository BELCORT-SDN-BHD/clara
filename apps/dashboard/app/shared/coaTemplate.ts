...
export const COA_TEMPLATE: CoaTemplateBlock[] = [
  ...
  },
  {
    ...
    accounts: [
      ...
      { code: "900-D01", name: "Directors' fees", type: "expense", mpers: "Administrative expenses", note: "Fees require member approval (Companies Act 2016 s.230) and do not attract EPF — keep apart from salary. CA 2016 s.249(4) disclosure." },
      ...
      {
        code: "900-I02",
        name: "Incorporation expenses — qualifying",
        type: "expense",
      ...
      {
        code: "900-I03",
        name: "Incorporation expenses — non-qualifying",
        type: "expense",
        mpers: "Administrative expenses",
        note: "Everything else in an incorporation bundle — secretarial fees, service tax, travelling, sundries. LHDN PR 11/2013 Example 5 is explicit that a single mixed 'preliminary expenses' account CANNOT be adjudicated, so the split is mandatory, not stylistic.",
      },
      ...
      {
        code: "900-E03",
        name: "Entertainment — fully deductible (s.39(1)(l) provisos)",
        type: "expense",
        mpers: "Administrative expenses",
      ...
      {
        code: "900-E04",
        name: "Entertainment — 50% restricted",
        type: "expense",
        mpers: "Administrative expenses",
        note: "ITA s.39(1)(l) disallows 50%: gifts without a logo, festive hampers, and — note — entertainment to SUPPLIERS, which PR 4/2015 excludes from the 'related wholly to sales' proviso.",
      },
      {
        code: "900-E05",
      ...
      },
      {
        ...
        type: "expense",
        mpers: "Administrative expenses",
        note: "ITA s.39(1)(m) disallows employee leave passage EXCEPT the s.39(1)(l)(viii) yearly local event with the employee's immediate family. Always a permanent add-back candidate — keep it alone.",
      },
  ...
  },
  {
    ...
    tier: "optional",
    blurb:
      "Near-universal for Malaysian SME motor vehicles. MPERS retains the finance/operating lease distinction (20.4) — it is NOT IFRS 16 — and 20.13(a) requires the net carrying amount by class, so HP assets stay separate from owned ones.",
    accounts: [
      ...
      { code: "470-H02", name: "Unexpired hire purchase finance charges (interest in suspense)", type: "liability", mpers: "Financial liabilities — contra", note: "Only needed where the contract is booked at gross instalment value; contra to the HP liability so it is measured per MPERS 20.9." },
