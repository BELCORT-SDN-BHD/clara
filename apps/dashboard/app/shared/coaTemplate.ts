  ...
  },
  {
    ...
    accounts: [
      ...
      },
      {
        ...
        type: "expense",
        mpers: "Administrative expenses",
        note: "Everything else in a formation bundle — secretarial fees, service tax, travelling, sundries. LHDN PR 11/2013 Example 5 disallowed exactly these inside a claimed incorporation cost, and states a mixed bundle cannot be adjudicated: the split is mandatory. Pre-commencement expenditure is generally NOT deductible (PR 11/2013 para 6.1); equity-issue costs reduce equity rather than being expensed.",
      },
