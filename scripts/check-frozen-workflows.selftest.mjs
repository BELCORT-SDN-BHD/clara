...
const ATTRIBUTION = [
  ...
  // opening figures a second time. It reaches NOTHING else — the module has no relative imports,
  // which #656 arranged on purpose so a Clara tool importing this door would not also freeze
