...
// round 0318_knowledge_fye_pair_applicability.sql, which re-cuts the rule at four arguments so
...
//
// THE NUMBER CLAIM IS WHAT ARMS THESE CELLS. Until 0310 AND 0318 are applied this file is the
