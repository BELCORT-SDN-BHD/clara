...
// `client_onboarding_facts$` stem (0204), which lands above several in-flight tickets. A
...
//
// THE COHORT CLAIM IS WHAT ARMS THE CELLS. Until 0204 is applied this file is the honest reason
