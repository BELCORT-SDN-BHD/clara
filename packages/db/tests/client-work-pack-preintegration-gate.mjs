// #650's client-work-pack battery is frontier-gated on the `client_work_pack$` stem, but a
...
// `client-work-pack.test.mjs` that a missing lane is an expected pre-integration state rather
// than a defect.
//
