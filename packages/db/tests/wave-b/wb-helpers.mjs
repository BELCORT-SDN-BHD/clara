...
// [0020 A6] p_note defaults to NULL because the DB now REFUSES a non-null note
// (CLR10 / source_note_not_permitted): a deterministic source page's bytes are
// machine-generated BY CONSTRUCTION, and the A5 exemption from max_pages_per_client
// rests on exactly that. Both production callers already pass null. A cell that WANTS
// the refusal passes a note explicitly.
