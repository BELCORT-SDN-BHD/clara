// C-3 is live-numbered as 0163_checkout_gate_c3_folded_door.sql. Package-wide CI keeps
// this preload so an intentionally older frontier skips LOUDLY; once 0163 is applied the
