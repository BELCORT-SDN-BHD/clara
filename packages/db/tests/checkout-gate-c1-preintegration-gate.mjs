// The C-1 migration is authored as UNNUMBERED_checkout_gate_c1_dpa.sql and is
// therefore deliberately skipped by the normal migration runner until merge prep.
// Package-wide CI preloads this module so the C-1 battery skips LOUDLY on the
