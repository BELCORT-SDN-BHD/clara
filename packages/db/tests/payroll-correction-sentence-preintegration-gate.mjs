// #1056's fix round ships as 0360_payroll_correction_sentences.sql. Every other in-flight ticket's
// rig sits below that frontier while this branch is unmerged, so package-wide CI preloads this
// module and the battery SKIPS LOUDLY there rather than failing for being early.
//
...
process.env.CLARA_ALLOW_MISSING_PAYROLL_CORRECTION_SENTENCES = "1";
