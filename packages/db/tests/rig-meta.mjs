...
// #620 [0185, the SUCCESSOR source-document byte door]: ONE granted name, on the same lane and for
...
const DOC_DOWNLOAD_0185_RUNTIME_FNS = ["get_document_for_human_read_v2"];
export const DOC_DOWNLOAD_0185_COHORT = [...DOC_DOWNLOAD_0185_RUNTIME_FNS];
...
export const ALLOWED = {
  ...
  [ROLES.runtime]: new Set([
    ...
    ...DOC_DOWNLOAD_0185_RUNTIME_FNS, // [#620, 0185] get_document_for_human_read_v2 — the SUCCESSOR
