...
begin
  ...
  -- (T.6) THE OVERRIDE DOOR STILL DOES NOT EXIST for this key, measured through the
  -- SHIPPING guard's own predicate rather than a restatement of it.
  select count(*)::int into v_n from clara.close_gate_checks
