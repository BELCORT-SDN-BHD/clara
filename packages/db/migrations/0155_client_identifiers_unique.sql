...
-- =====================================================================================
-- The inventory is a MEASURED prosrc-text census, not a reading list (§0.8 states exactly what
-- that census can and cannot see; it is NOT closed-world). §0.8 enumerates every function in
