...
// arms: this file spawns the same server against the same throwaway databases, and a gate that
// admitted one more name here would be a second, looser answer to one question.
assertLocalDbGate({
  label: "chat-turn-v19-e2e",
