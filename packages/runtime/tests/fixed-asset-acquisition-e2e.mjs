...
// composed shape as `work-journal-e2e.mjs`'s and `periodic-adjustment-e2e.mjs`'s rt_test/wave_b_ci
// arms, deliberately: this file spawns the same server against the same throwaway databases, and
// a gate that admitted one more name here would be a second, looser answer to one question.
assertLocalDbGate({
  label: "fixed-asset-acquisition-e2e",
