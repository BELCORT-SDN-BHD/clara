...
// composed shape as `periodic-adjustment-e2e.mjs`'s, deliberately: this file spawns the same
// server against the same throwaway databases, and a gate that admitted one more name here would
// be a second, looser answer to one question. Both moved together to admit the riders wave's
// per-lane `clara_l<NN>` (#980), and they stay one answer.
assertLocalDbGate({
  label: "staff-expense-claim-e2e",
