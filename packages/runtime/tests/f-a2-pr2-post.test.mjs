...
test("f-a2.pr2.registry: chatTurn and autoDraft are repointed, and v8/v12 stay EXPORTED so no parked run is stranded", () => {
  assert.equal(registry.workflows.autoDraft.name, "autoDraft_v9");
  assert.equal(registry.workflows.chatTurn.name, "chatTurn_v13");
  ...
  assert.equal(registry.chatTurn_v13, registry.workflows.chatTurn);
