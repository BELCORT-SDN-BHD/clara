...
test("the registry repoints chatTurn: to chatTurn_v14, and v14 is exported alongside v13", () => {
  ...
  assert.equal(registry.workflows.chatTurn, v14Module.chatTurn_v14, "workflows.chatTurn === chatTurn_v14");
