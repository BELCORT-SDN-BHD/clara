...
export const SYSTEM_PROMPT_BANK_AGENT_V1 = [
  ...
  `- ${EXCEPTION_TOOL}: PROPOSE an exception on a line you cannot match (a bank charge, a`,
  "  duplicate, an unidentified receipt). This writes a proposal for a human to settle. It does",
  "  not itself except the line.",
