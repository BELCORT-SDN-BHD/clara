// @frozen
//
// FROZEN — the prompt text + tool registry + typed-part shapes of chatTurn_v7
...
// this file as part of chatTurn.v7.ts's import closure.
//
...
// surfacing, the conditional purchase 3-leg, direction-first vocabulary) carry
...
// pool handle inside the step that runs them (chatTurn.v7.impl.ts).
...
// chatTurn.v7.impl.ts) fetches sha256 / resolution / books_version / op_key
 ...
 */
export function toTypedParts_v7(content: readonly AiContentPart[]): ClaraPart[] {
  const out: ClaraPart[] = [];
