// @frozen
//
// FROZEN — the autoDraft_v3 tool set + the draft_journal_entry write-floor wrapper
...
import { refusalFromDbError } from "./autoDraft.v3.errors.js";
import { readScoped, writeScoped, safeRead, type PgExec, type ToolCtx } from "./autoDraft.v3.infra.js";
