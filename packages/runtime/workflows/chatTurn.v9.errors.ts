// @frozen
//
// FROZEN — the runtime CLR -> typed-refusal map for chatTurn_v9 (contract §12 /
...
// the CLR->refusal map is unaffected. This wave's ONE behavioural change (the
// sales-vs-supplier-bill framing reinforcement) lives entirely in
// chatTurn.v9.prompt.ts.

import type { RefusalPart } from "./chatTurn.v9.prompt.js";
