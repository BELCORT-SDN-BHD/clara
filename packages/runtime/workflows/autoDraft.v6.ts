...
//
// autoDraft_v6 (§7-A THE UNATTENDED SALES DRAFTER, wave-7a-contract.md, ADR-063): this file
// is an UNMODIFIED version-rename of v5 — the claim/recover/model/settle/question/close
// happy path, the catch block's refusalFromCaughtError delegation, and the finally block are
// byte-identical. This wave's functional changes live entirely OUTSIDE this file:
...
// autoDraft.v6.errors.ts's three new refusal tokens + direction-neutral generics, and
// autoDraft.v6.impl.ts's settle call moving to the 6-arity settle_autodraft_task overload
// (full rationale in each file's own header).
//
