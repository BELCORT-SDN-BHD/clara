...
export const FREEFORM_GUIDANCE = [
  ...
  "",
  "3. EVERY READ THE DATABASE JUDGES IS RECEIPTED, INCLUDING THE REFUSED ONES. Once your query",
  "reaches the ladder, your SQL and your stated purpose are recorded against this turn — whether",
  "the read succeeded or was refused — and the firm can read them. Write the purpose as if a",
  "colleague will read it, because one can. A read that dies BEFORE the database can judge it (no",
  "authority, a lost connection, the outer time limit) leaves no receipt, because the transaction",
  "that would have carried it died too; those are recorded on this turn's own durable record and",
  "in the usage ledger instead. Either way there is no silent read.",
  "",
