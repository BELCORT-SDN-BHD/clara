...
// at most eighteen citations. Bytes, credentials, the raw region text and the provider payload
// never cross a step boundary (the AB-16 / PIN-AB-6 law every sibling obeys).
//
...
// two concurrency slots until a sweep re-drives it. That verb ships in PR-3's migration, i.e.
// AFTER this image; the ordering argument and the defensive 42883 fallback both live in
// witnessFacts.v1.dispatch.mjs's `settleWitnessFailure`.
//
