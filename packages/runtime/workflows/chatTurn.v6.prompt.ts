// @frozen
//
// FROZEN — the prompt text + tool registry + typed-part shapes of chatTurn_v6
...
// pool handle inside the step that runs them (chatTurn.v6.impl.ts).
...
// chatTurn.v6.impl.ts) fetches sha256 / resolution / books_version / op_key
 ...
 */
export function toTypedParts_v6(content: readonly AiContentPart[]): ClaraPart[] {
  const out: ClaraPart[] = [];
