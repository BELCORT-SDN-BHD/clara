...
// reads and the draft write are BYTE-CARRIED from v8's `buildAutoDraftTools`; what is NEW is the
// sixth tool, `post_journal_entry`, and the two guards around it.
//
...
import { runDraftJournalEntry, newReadSnapshots, extractRev, type DraftInput } from "./autoDraft.v9.tools.js";
