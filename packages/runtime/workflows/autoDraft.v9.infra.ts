// @frozen
//
// FROZEN — part of the autoDraft_v9 closure (F-A1 PR-3a; see autoDraft.v9.tools.ts for the one
...
//
// THIS FILE (infra) — an UNMODIFIED version-rename of v7: the pool/credential/model
// resolution plumbing, ToolCtx (including PR #204's `direction` field) and safeRead are
// byte-identical; only the import path and the version in the prose moved. F-A1 changes
// nothing about infrastructure.

import { openai } from "@ai-sdk/openai";
import { readToolRefusalMessage } from "./autoDraft.v9.errors.js";
