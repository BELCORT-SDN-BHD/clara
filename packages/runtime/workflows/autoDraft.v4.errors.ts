// @frozen
//
// FROZEN — the runtime CLR -> typed-refusal map for autoDraft_v4 (contract §10 / pins §6).
...
// CLR->refusal map is unaffected by the model-id/stream-error fix, which lives entirely in
// autoDraft.v4.impl.ts's runAutoDraftModelStep.

import type { RefusalPart } from "./autoDraft.v4.prompt.js";
