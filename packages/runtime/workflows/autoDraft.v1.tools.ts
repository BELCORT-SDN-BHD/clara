// @frozen
//
// FROZEN — the autoDraft_v1 tool set + the draft_journal_entry write-floor wrapper
...
import { refusalFromDbError } from "./autoDraft.v1.errors.js";
import { readScoped, writeScoped, safeRead, type PgExec, type ToolCtx } from "./autoDraft.v1.infra.js";
