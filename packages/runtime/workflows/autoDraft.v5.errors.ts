// @frozen
//
// FROZEN — the runtime CLR -> typed-refusal map for autoDraft_v5 (contract §10 / pins §6).
...
//
// v5 vs v4 (ledger #46, owner ruling 2026-07-29 — the SST-zero precedent): this file is an
// unmodified version-rename of v4 — the CLR->refusal map is unaffected. This wave's ONLY
// functional change is the purchase-leg SHAPE rule in autoDraft.v5.prompt.ts (+ its
// .describe() echo in autoDraft.v5.tools.ts): a stated ZERO tax figure now takes the
// two-leg shape, matching how the owner's own four approved EZSEC entries (all printing
// "SST Amt @ 6%: 0.00") were actually posted. CLR21 reason `coding_incomplete` (the code
// IV-00743's parked attempt 2 settled under) is untouched by this rename.

import type { RefusalPart } from "./autoDraft.v5.prompt.js";
