// @frozen
//
// FROZEN — injected-infrastructure accessors + wake-credential scoping for the autoDraft_v5
...
// unmodified version-rename of v4. resolveModel itself is unchanged: it still just forwards
// whatever model_snapshot string it is handed to @ai-sdk/openai's default provider. This
// wave's ONLY functional change lives in autoDraft.v5.prompt.ts / autoDraft.v5.tools.ts.

import { openai } from "@ai-sdk/openai";
import { readToolRefusalMessage } from "./autoDraft.v5.errors.js";
