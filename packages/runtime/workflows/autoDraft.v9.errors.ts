// @frozen
//
// FROZEN — part of the autoDraft_v9 closure (F-A2: the AGENTIC POSTING lane; design
// docs/plan/active/f-a2-agentic-posting-design.md §3, annexes 1-4, PR-0 gate record). A NEW
// frozen closure beside the byte-untouched autoDraft_v1..v8 (ARCHITECTURE Appendix A: a
// behavioural change ships as a new _vN export, never an in-place edit — the registry repoints
// `autoDraft:` here). See autoDraft.v9.tools.ts for the one statement of what v9 changes.
//
// THIS FILE (errors) — v9 vs v8: the whole DRAFT-lane vocabulary is BYTE-CARRIED (the CLR code
// table, all eleven CLR21 reason messages, the CLR10 sst_account_missing branch, the
// 23505/23503/23514 native collapse, the structural 42501 -> CLR03 mapping,
// readToolRefusalMessage, the noFilingRefusal/noDraftRefusal/directionFamilyMismatchRefusal
// factories and evidenceIdxUnresolvedRefusal's EvidenceFailure machinery). What is ADDED is the
// POST lane's closed refusal vocabulary (design Annex E.2), in three named sets that never mix:
//
