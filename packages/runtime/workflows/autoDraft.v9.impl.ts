...
// byte-untouched autoDraft_v1..v8 (ARCHITECTURE Appendix A: a behavioural change ships as a new
// _vN export, never an in-place edit — the registry repoints `autoDraft:` here).
//
...
import { buildAutoDraftTools } from "./autoDraft.v9.toolset.js";
