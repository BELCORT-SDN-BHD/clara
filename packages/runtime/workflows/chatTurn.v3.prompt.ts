// @frozen
//
// FROZEN — the prompt text + tool registry + typed-part shapes of chatTurn_v3
...
// this file as part of chatTurn.v3.ts's import closure.
//
...
//   * in-turn attachment perception: `messageFromParts_v3` surfaces an attachment
...
// pool handle inside the step that runs them (chatTurn.v3.impl.ts).
...
// chatTurn.v3.impl.ts) fetches sha256 / resolution / books_version / op_key
 ...
 */
export function toTypedParts_v3(content: readonly AiContentPart[]): ClaraPart[] {
  const out: ClaraPart[] = [];
