// @frozen
//
// FROZEN — the autoDraft_v4 tool set + the draft_journal_entry write-floor wrapper
...
//
// v4 vs v3 (ledger #44/GitHub #42): this file is an unmodified version-rename of v3 — the
// tool set, the read/write shapes, and the draft-wrapper are unaffected by this wave's fix.
//
...
import { refusalFromDbError } from "./autoDraft.v4.errors.js";
import { readScoped, writeScoped, safeRead, type PgExec, type ToolCtx } from "./autoDraft.v4.infra.js";
