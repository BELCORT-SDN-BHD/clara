// @frozen
//
// FROZEN — part of the autoDraft_v8 closure (F-A1 PR-3a: the consumer re-versioning that
// widens the coding-lane toolfaces to the witness-pair regime; see autoDraft.v8.tools.ts for
...
//
// THIS FILE (the workflow entry) — an UNMODIFIED version-rename of v7: the
...
// (autoDraft.v8.impl / .tools / .infra / .prompt / .errors) once deployed — ship a
// behavioural change as autoDraft_v9.
...
} from "./autoDraft.v8.impl.js";
import { isQuestionShaped } from "./autoDraft.v8.prompt.js";
import { noDraftRefusal } from "./autoDraft.v8.errors.js";
...
export async function autoDraft_v8(input: { taskId: string }): Promise<{ taskId: string; outcome: string }> {
  "use workflow";
