// @frozen
//
// FROZEN — the runtime CLR -> typed-refusal map for chatTurn_v8 (contract §12 /
...
//
// v8 vs v7 (owner-approved closing batch, 2026-07-29): this file is an unmodified
// version-rename of v7 — the CLR->refusal map is unaffected. This wave's three
// functional changes (the stream-error diagnostic port, the SST-zero tax-rule
// propagation, and bind-existing-counterparty guidance) live in
// chatTurn.v8.impl.ts / chatTurn.v8.ts / chatTurn.v8.prompt.ts /
// chatTurn.v8.tools.ts.

import type { RefusalPart } from "./chatTurn.v8.prompt.js";
