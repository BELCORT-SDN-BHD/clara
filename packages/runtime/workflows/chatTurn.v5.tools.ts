// @frozen
//
// FROZEN — the chatTurn_v5 tool set + the draft_journal_entry write-floor wrapper
...
// v5: coding_kind "journal_entry" maps to NULL at the writer (the generic voucher
...
import { refusalFromDbError, sessionUnboundRefusal } from "./chatTurn.v5.errors.js";
import { readScoped, writeScoped, safeRead, type PgExec, type ToolCtx } from "./chatTurn.v5.infra.js";
 ...
 */
export function buildToolsV5(ctx: ToolCtx) {
  const clientId = ctx.clientId;
  const firmScoped = {
