...
// chatTurn_v1..v21.
//
// THE STAMP MOVES; THE RECORDER DOES NOT. v16's..v21's own arrangement carried forward:
...
// Only this closure's chat engine label changes, from `chatturn-v21` to `chatturn-v22`.
//
...
// metering ledger can never attribute a v22 turn to the v21 body.
...
export function chatEngineId(modelId: string): string {
  return `llm-openai:${modelId}:chatturn-v22`;
}
