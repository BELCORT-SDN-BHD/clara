...
//
// THIS FILE (errors) — an UNMODIFIED version-rename of v7: the CLR code table, all eleven
// CLR21 reason messages, the CLR10 sst_account_missing branch, the 23505/23503/23514 native
// collapse, the structural 42501 -> CLR03 mapping, readToolRefusalMessage, the
// noFilingRefusal/noDraftRefusal/directionFamilyMismatchRefusal factories, and
// evidenceIdxUnresolvedRefusal's whole EvidenceFailure machinery are byte-identical; only the
// import path (RefusalPart from autoDraft.v8.prompt.js) and the version in the prose moved.
// F-A1 changes nothing about error mapping.

import type { RefusalPart } from "./autoDraft.v8.prompt.js";
