// @frozen
//
// FROZEN — the prompt text + tool registry + typed-part shapes of chatTurn_v8
// (Slice-6 coding floor; contract §3). This is a NEW frozen closure beside the
// byte-untouched chatTurn_v1..v7 (Appendix A: a behavioural change ships as a new
// _vN, never an in-place edit — the WDK has no run-pinning). The freeze-lint
// hash-locks this file as part of chatTurn.v8.ts's import closure.
//
// v8 vs v7 (owner-approved closing batch, 2026-07-29) — TWO functional changes in
// THIS file, both prompt/schema text only (the schema STRUCTURE, the tool mapping,
...
// pool handle inside the step that runs them (chatTurn.v8.impl.ts).
...
// chatTurn.v8.impl.ts) fetches sha256 / resolution / books_version / op_key
 ...
 */
export function toTypedParts_v8(content: readonly AiContentPart[]): ClaraPart[] {
  const out: ClaraPart[] = [];
